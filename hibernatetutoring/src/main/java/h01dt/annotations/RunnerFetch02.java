...
public class RunnerFetch02 {
	...
	public static void main(String[] args) {
		...
		Configuration con = new Configuration().configure("hibernate12.cfg.xml").addAnnotatedClass(Students01.class);
...
//		System.out.println(result2);
		...
		String hqlQuery3 = "FROM Students01  WHERE grade = 11";
		String hqlQuery4 = "SELECT s.name FROM Students01  s WHERE grade = 11";
